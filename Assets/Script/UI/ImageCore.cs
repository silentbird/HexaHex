  ...
  public abstract class ImageCore : MaskableGraphic, ILayoutElement, ICanvasRaycastFilter
  {
    ...
    public override Material material
    {
      get
      {
        ...
        return (bool) (UnityEngine.Object) this.activeSprite && (bool) (UnityEngine.Object) this.activeSprite.associatedAlphaSplitTexture ? ImageCore.defaultETC1GraphicMaterial : this.defaultMaterial;
      }
    ...
    protected Vector4 GetDrawingDimensions(bool lPreservAspect)
    {
      ...
      Vector4 vector4 = new Vector4(spritePadding.x / (float) num1, spritePadding.y / (float) num2, ((float) num1 - spritePadding.z) / (float) num1, ((float) num2 - spritePadding.w) / (float) num2);
      ...
      return new Vector4(pixelAdjustedRect.x + pixelAdjustedRect.width * vector4.x, pixelAdjustedRect.y + pixelAdjustedRect.height * vector4.y, pixelAdjustedRect.x + pixelAdjustedRect.width * vector4.z, pixelAdjustedRect.y + pixelAdjustedRect.height * vector4.w);
    }
    ...
    public virtual bool IsRaycastLocationValid(Vector2 screenPoint, Camera eventCamera) => !(bool) (UnityEngine.Object) this.activeSprite || RectTransformUtility.ScreenPointToLocalPointInRectangle(this.rectTransform, screenPoint, eventCamera, out Vector2 _);
  }
}
